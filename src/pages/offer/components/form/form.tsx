...
const ARRAY_OF_STARS = [5,4,3,2,1];
...
function Form({onHandleSubmitForm, isDisableForm}:{onHandleSubmitForm:(data:FormDataProps, cb: () => void) => Promise<void>; isDisableForm: boolean}):JSX.Element {
